...
const {
  DEFAULT_SHEET_ID, quoteTab, loadServiceAccount, getAccessToken,
...
// Google service-account auth + Sheets v4 client now live in ./lib/google-sheets
// (imported at the top of this file). Behaviour is unchanged.
