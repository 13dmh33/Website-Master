...
local branches present. Reading `refs/remotes/origin/` instead would fix this without
needing local branch creation — a real follow-up, not done here.
