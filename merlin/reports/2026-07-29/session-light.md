...
**Target usage:** light — a day with less available capacity. Estimated queue: ~2.5h.
...
2. **Unstick the "checked" stage — 455 leads have sat there with zero movement since the previous run (642 reached, unchanged)** (~0.5h)
...
4. **Unstick the "scouted" stage — 58 leads have sat there with zero movement since the previous run (702 reached, unchanged)** (~0.5h)
