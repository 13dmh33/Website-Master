...
All previously-listed merge/demo tasks are done (verified 2026-06-22: trevo-advisors-review-Sjewy,
molly-ui-polish, and scout-refinement are all merged to main with zero diff; handyman demo exists
in website/demos/). Nothing queued here right now — check `miley/docs/roadmap-specs.md` for the
next batch of specced build work (content-quality features for Miley) when ready to pick one up.
